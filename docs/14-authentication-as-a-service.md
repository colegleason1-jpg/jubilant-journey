...
## Positioning: use the room you have

Presenting real work well is ordinary business, and there is far more room here than
most dealers use. Everything below is generated by `positioningClaims()` from what the
operation actually does — and every line passes the claims guard:
...
> • Priced against 90 days of verified sold comparables, not against asking prices.
...
That reads like a serious operation because it **is** one — the scanner really does
screen thousands of listings, the comp engine really does price against sold data, and
the SOP really does log serials and record packing. Each line is specific enough to be
checked, which is exactly why it lands harder than a vague version would.
...
know what the first one means. Specificity is the sophistication.
