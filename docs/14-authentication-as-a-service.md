...
Generated by `positioningClaims()` from what the operation actually does:
...
>   assessed to the same standard on every watch.
...
> • 30-day returns, no questions asked, from a named business with a phone number that
>   reaches a person.

Inspection, documentation, pricing discipline, packaging, service. That's what a
serious dealer talks about. The sourcing engine stays internal where it belongs.
